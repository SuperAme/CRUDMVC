...
<div class="card card-body bg-light mt-5">
    ...
    <form action="<?php echo RUTA_URL; ?>/pages/editar/<?php echo $datos['id_usuario']; ?>" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="telefono" class="form-control form-control-lg" value="<?php echo $datos['nombre']; ?>">
        </div>
